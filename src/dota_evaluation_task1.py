...
def eval_dota_task1(det_path, det_thresh=0.3):

    anno_path = r'/media/data/DOTA/val/labelTxt-v1.0/labelTxt/{:s}.txt'
...
if __name__ == '__main__':
    det_path = r'/root/out/DOTA/adap_results/Task1_{:s}.txt'
    eval_dota_task1(det_path, det_thresh=0.01)
