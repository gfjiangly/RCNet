...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--fpn', action='store_true',
                                 help='use multiple outputs or not.')
        ...
        self.parser.add_argument('--a_method', type=int, default=1,
                                 help='angle represent method.')

        # train
        self.parser.add_argument('--lr', type=float, default=1e-3,
                                 help='learning rate for batch size 32.')
        self.parser.add_argument('--lr_step', type=str, default='40,60',
                                 help='drop learning rate by 10.')
        # self.parser.add_argument('--lr_step', type=str, default='15',
        #                          help='drop learning rate by 10.')
        self.parser.add_argument('--warmup', action='store_true',
                                 help='warm up lr.')
        self.parser.add_argument('--warmup_iters', type=int, default=200,
                                 help='warm up iters num.')
        ...
        self.parser.add_argument('--keep_res', action='store_true',
                                 help='keep the original resolution'
                                      ' during validation.')
        self.parser.add_argument('--replace_hm', action='store_true',
                                 help='replace center points with GT')
        self.parser.add_argument('--replace_wh', action='store_true',
                                 help='replace size with GT')
        self.parser.add_argument('--replace_a', action='store_true',
                                 help='replace angle with GT')
        self.parser.add_argument('--replace_o', action='store_true',
                                 help='replace offset with GT')
        self.parser.add_argument('--val_result', action='store_true',  # 直接评估检测结果，不再运行模型
                                 help='')
        ...
        self.parser.add_argument('--no_color_aug', action='store_true',
                                 help='not use the color augmenation '
                                      'from CornerNet')
        self.parser.add_argument('--weighted', action='store_true',
                                 help='use WeightedRandomSampler or not.')
        ...
        self.parser.add_argument('--start_wh', type=int, default=0,
                                 help='start train wh from start_wh epoch')
        self.parser.add_argument('--start_a', type=int, default=0,
                                 help='start train angle from start_a epoch')
        self.parser.add_argument('--related_hm', action='store_true',
                                 help='associate wh_loss and a_loss with hm_loss')
        # multi_pose
    ...
    def parse(self, args=''):
        ...
        opt.num_fpn = 3 if opt.fpn else 1
        ...
        opt.data_dir = os.path.join('/media/data')
        opt.exp_dir = os.path.join(opt.root_dir, 'exp', opt.task)
        time_str = time.strftime('%Y-%m-%d-%H-%M')
        opt.save_dir = os.path.join(opt.exp_dir, opt.exp_id, 'logs_{}'.format(time_str))
