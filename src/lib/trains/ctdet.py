...
class CtdetTrainer(BaseTrainer):
    def __init__(self, opt, model, optimizer=None):
        ...
        self.debugger = Debugger(dataset=opt.dataset, 
                                 ipynb=(opt.debug == 3),
    ...
    def debug_for_loss(self, loss_stats, iter_id):
        self.debugger.add_loss(loss_stats)
        if iter_id % 100 == 0:
            to_file = f'{self.opt.debug_dir}/iter{iter_id}_loss.png'
            self.debugger.draw_loss(iter_id, to_file=to_file)
